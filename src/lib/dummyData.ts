...
export const DUMMY_USERS: UserProfile[] = [
  {
    ...
    publicIntro: "情報工学科3年の佐藤拓海です。研究室配属や進路について相談できる方を探しています。",
    avatar: "👨‍🎓",
    topics: ["履修登録", "研究室選び"],
    contactMethods: [],
  ...
  },
  {
    ...
    publicIntro: "計算機アーキテクチャ研究室の鈴木茂です。研究室配属・卒論指導・進路相談を受け付けています。メールでの事前連絡をお願いします。",
    avatar: "👨‍🏫",
    topics: ["研究室選び", "卒論指導", "計算機システム", "進路相談"],
    contactMethods: [
      { type: "discord", label: "Discord", value: "suzuki_arch_lab" },
    ],
  ...
  },
  {
    ...
    publicIntro: "知能情報システム研究室の高橋美咲です。AI・データサイエンス・女子学生のキャリアサポートに力を入れています。気軽にご連絡ください。",
    avatar: "👩‍🏫",
    topics: ["研究室選び", "履修登録", "AI・データサイエンス", "女子学生サポート"],
    contactMethods: [
      { type: "twitter", label: "Twitter/X", value: "@m_takahashi_ai" },
      { type: "slack", label: "研究室Slack", value: "iss-lab.slack.com" },
    ],
  ...
  },
  {
    ...
    role: "職員",
    department: "学生支援本部",
    publicIntro: "進路支援課です。就職・進学・インターンシップに関するご相談をお受けしています。平日9〜17時、A棟1階窓口またはオンラインでご利用いただけます。",
    avatar: "🏢",
    topics: ["進路相談", "就職活動", "履歴書添削", "模擬面接", "インターンシップ"],
    contactMethods: [
      { type: "custom", label: "予約フォーム", value: "https://career.univ.ac.jp/reserve" },
    ],
  ...
  },
  {
    ...
    publicIntro: "プログラミング演習担当TAの田中健太です。C言語・Pythonの質問や課題相談を気軽に受け付けています。DiscordのDMが一番早いです。",
    avatar: "🧑‍💻",
    topics: ["プログラミング質問", "講義の課題", "研究室の日常", "院試対策"],
    contactMethods: [
      { type: "discord", label: "Discord", value: "kenta_ta#4892" },
      { type: "github", label: "GitHub", value: "kenta-tanaka-ta" },
    ],
